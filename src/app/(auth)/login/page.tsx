...
export default function LoginPage() {
  ...
  const handleUserResult = async (firebaseUser: { uid: string; displayName: string | null; email: string | null; getIdToken: () => Promise<string> }) => {
    // Set session cookie via server
    try {
      ...
      // Session cookie failed — continue anyway, middleware will redirect on next visit
    }
